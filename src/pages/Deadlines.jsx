...
import Deadlines1 from "../assets/Deadlines/12.png"
import Deadlines2 from "../assets/Deadlines/123.png"
import Deadlines3 from "../assets/Deadlines/1234.png"
      ...
      <div className="flex-1 flex flex-col">
        ...
        <div className="flex-1 flex">
          <main className="flex-1 p-4 md:p-6">
            <Directory location="Deadlines" />
            <h1 className="text-4xl font-bold mb-4">Deadlines</h1>
            <section id="#new-Tasks">
              <h2 className="text-lg "> The <strong>Deadlines</strong> section consolidates all your due dates, ensuring you never miss important milestones for tasks, goals, and projects.
              </h2>
            </section>
            ...
            <section className="mt-6" id="#categories">
              ...
              <ul className="list-disc ml-6">
                <li><strong>See Upcoming Deadlines:</strong> See all upcoming deadlines in a single view.</li>
                ...
                <li><strong>View Previous and Next Week:</strong> Navigate through past and future deadlines seamlessly.</li>
              </ul>
            </section>

            <section className="mt-6" id="#features">

              <img src={Deadlines1} alt="" />
              <img src={Deadlines2} alt="" />
              <img src={Deadlines3} alt="" />

            </section>

            <section className="mt-6">
              <p>Deadlines can be filtered by project or priority level, ensuring that critical tasks are never overlooked. Automated reminders help prevent missed deadlines.</p>
            </section>

            <section className="mt-6">
              <div className="flex flex-row items-center justify-between">

                <a href="/testing/pomodoro" className="flex flex-row items-center justify-center"> <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20"
                  viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide 
                                lucide-chevron-left"><path d="m15 18-6-6 6-6" /></svg> Pomodoro </a>

                <a href="/testing/ask-ai" className="flex flex-row items-center justify-center"> Ask AI <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor"
